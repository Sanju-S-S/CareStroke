          ...
          child: GridView.extent(
            ...
            children: <Widget>[
              Container(
                ...
                child: const Image(image: AssetImage('lib/assets/wrist-and-hand/1.jpg')),
                color: Colors.white,
              ),
              Container(
                padding: const EdgeInsets.all(8),
                child: const Image(image: AssetImage('lib/assets/wrist-and-hand/2.jpg')),
                color: Colors.white,
              ),
              new Container(
